...
export default function LoginPage() {
  ...
  console.log("Trying login with:", email, "password length:", password.length);
  ...
  try {
    ...
    console.log("Response:", JSON.stringify(data), JSON.stringify(signInError));
    ...
    <div style={{ background:"#0a0a0a", minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Inter',sans-serif", padding:20 }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .login-btn{width:100%;background:#c8973a;color:#0a0a0a;border:none;border-radius:12px;padding:15px;font-size:16px;font-weight:700;cursor:pointer;font-family:inherit;transition:background 0.15s}
        .login-btn:hover{background:#a67c2e}
      ...
      <div style={{ width:"100%", maxWidth:400, animation:"fadeIn 0.4s ease" }}>
        ...
        <div style={{ background:"#141414", border:"1px solid #222", borderRadius:20, padding:28 }}>
          ...
          <div style={{ marginBottom:14 }}>
            ...
            <input className="input" type="email" placeholder="admin@zarincafe.com" value={email} onChange={e=>setEmail(e.target.value)} onKeyDown={e=>e.key==="Enter"&&handleLogin()}/>
          </div>
        ...
        <p style={{ textAlign:"center", color:"#333", fontSize:12, marginTop:20 }}>
          Customer menu is public — no login needed
        </p>
      </div>
    </div>
  );
